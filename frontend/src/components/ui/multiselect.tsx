  ...
  (
    ...
    return (
      ...
      >
        <div
          className={cn(
            "relative !mb-1 min-h-[38px] rounded-lg border border-input text-sm ring-offset-background transition-shadow focus-within:border-ring focus-within:ring-2 focus-within:ring-ring/30 focus-within:ring-offset-2 has-[:disabled]:cursor-not-allowed has-[:disabled]:opacity-50",
            {
              "p-1": selected.length !== 0,
              "cursor-text": !disabled && selected.length !== 0,
              "!border-red-500 !focus-visible:ring-destructive/30": error,
            },
        ...
        {error && (
          <span className="text-red-500 text-sm">{error as string}</span>
        )}
      </Command>
    );
  }
