...
export default function DashboardOverview() {
  ...
  const isGroupLeader = ["President", "Accountant", "Secretary"].includes(user?.role?.name);
        ...
        <TabsContent value="overview" className="space-y-6">
          <div className="grid gap-2 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4">
            <Card className="shadow-none rounded-md">
              <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
                <CardTitle className="text-sm font-medium">
                  {isGroupLeader ? "Total Savings (Your Group)" : "Total Savings Across All Groups"}
                </CardTitle>
            ...
            <Card className="shadow-none rounded-md">
              <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
                <CardTitle className="text-sm font-medium">
                  {isGroupLeader ? "Active Members (Your Group)" : "Active Members"}
                </CardTitle>
            ...
            <Card className="shadow-none rounded-md">
              <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
                <CardTitle className="text-sm font-medium">
                  {isGroupLeader ? "Active Loans (Your Group)" : "Active Loans"}
                </CardTitle>
            ...
            {isAdmin && analytics?.totalGroups !== undefined && (
              <Card className="shadow-none rounded-md">
                <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
                  <CardTitle className="text-sm font-medium">
                    Total Groups
            ...
            {isAdmin && analytics?.branchesCount !== undefined && (
              <Card className="shadow-none rounded-md">
                <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
                  <CardTitle className="text-sm font-medium">
                    Sectors Count
            ...
            <Card className="shadow-none rounded-md">
              <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
                <CardTitle className="text-sm font-medium">
                  {isGroupLeader ? "Loans Balance (Your Group)" : "Loans Balance"}
                </CardTitle>
                <CreditCard className="w-4 h-4 text-muted-foreground" />
              </CardHeader>
              <CardContent>
            ...
            <Card className="shadow-none rounded-md">
              <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
                <CardTitle className="text-sm font-medium">
                  {isGroupLeader ? "Repayment Rate (Your Group)" : "Repayment Rate"}
                </CardTitle>
          ...
          <Card className="shadow-none rounded-md">
            <CardHeader className="flex border-b flex-col sm:flex-row sm:items-center justify-between">
              <div className="space-y-2">
                ...
                <CardDescription>
                  {isGroupLeader ? "Latest member contributions in your group" : "Latest member contributions across all groups"}
                </CardDescription>
              </div>
